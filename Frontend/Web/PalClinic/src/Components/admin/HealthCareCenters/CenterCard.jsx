...
export default function CenterCard({ center, onDeactivate, onEdit }) {
  ...
  return (
    <div style={box}>
      ...
      <div style={row}>
        <strong>النوع:</strong> {center.centerType}
      </div>
      <div style={row}>
        <strong>العنوان:</strong> {center.address}
      </div>
      <div style={row}>
        <strong>الهاتف:</strong> {center.phoneNumber}
      </div>
      <div style={row}>
        <strong>البريد:</strong> {center.email}
      </div>
      <div style={row}>
        <strong>الوصف:</strong> {center.discrption}
      </div>
