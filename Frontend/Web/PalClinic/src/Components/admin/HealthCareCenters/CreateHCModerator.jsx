...
import { createHCModerator } from "../../../API/Moderators";
import { Theme } from "../../../assets/Theme/Theme1";

export default function CreateHCModerator() {
  ...
  const onSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await createHCModerator(form);
  ...
  return (
    <>
      ...
      <form style={S.card} onSubmit={onSubmit}>
        <label style={S.label}>اسم المشرف</label>
        <input
          style={S.input}
          value={form.name}
